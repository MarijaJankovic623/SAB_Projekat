 ...
 * @author Marija
 */
public class PregledRezervacijaKupac extends javax.swing.JPanel {
     ...
     */
    public PregledRezervacijaKupac(SAB_Projekat Home) {
        initComponents();
        this.Home = Home;

        List<Rezervacija> rezervacije = Kupac.pregledRezervacijaKupac();
        ...
        if (rezervacije.size()>0) {
            ...
            ispis = "Jos uvek nemate rezervacije";
        }
